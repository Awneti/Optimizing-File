...
echo.  
echo.                                                                  
echo			`7MMF'     A     `7MF'.M"""bgd   .g8"""bgd                        
echo			  `MA     ,MA     ,V ,MI    "Y .dP'     `M                        
echo			   VM:   ,VVM:   ,V  `MMb.     dM'       `     `7M'   `MF'pd*"*b. 
echo			    MM.  M' MM.  M'    `YMMNq. MM                VA   ,V (O)   j8 
echo			    `MM A'  `MM A'   .     `MM MM.                VA ,V      ,;j9 
echo			     :MM;    :MM;    Mb     dM `Mb.     ,'         VVV    ,-='    
echo			      VF      VF     P"Ybmmd"    `"bmmmd'           W    Ammmmmmm 		                                                                   			                                                         
echo.
echo.
pause